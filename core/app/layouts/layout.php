...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Dulces y Abarrotes | Rancho Nuevo</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>Rancho Nuevo </b>ABAROTES</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="#" target="_blank" class="">Configuracion</a>
                      <a href="#" target="_blank" class="">Mas...</a>
                  </li>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2017 <a href="#" target="_blank">Crispin Freenlance</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">DULCERIA Y ABAROTES <b>RANCHO NUEVO</b></a>
      </div><!-- /.login-logo -->
